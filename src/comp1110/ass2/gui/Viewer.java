...
//        (700-600)/2=50
    ...
    private void makeText(Text text) {
...
//        700/2=350
        ...
        text.toFront();
        this.root.getChildren().add(this.boardStateErrorText);
